...
export default class Cameras extends Iterable {
	#processStartHandler = (processToken, camera) => this.emit('processStart', processToken, camera);
	#processStopHandler = (processToken, camera) => this.emit('processStop', processToken, camera);
